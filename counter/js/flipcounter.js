...
var flipCounter = function(d, options){
   ...
   */
  this.step = function(){
      $("#champi").removeClass("champisation");
    if (!counter.auto) _doCount();
//      $("#gtest").append("</br>points : "+this.getValue());

      //$('.guitarCounter').effect('pulsate', { times: 1 }, 500);
      $('.guitarCounter').addClass("rotation");
      $("#slider img.top").toggleClass("transparent");
      $("#slider img.bottom").toggleClass("transparent");
...
if (m480==false){
      switch (this.getValue()) {
              ...
              case 2 :
                  $('#hadoken')[0].play();
                  $("#flame").addClass("flamisation");
                  break;
              case 3 :
                  $('#powerUp')[0].play();
                  $("#champi").addClass("champisation");
                  break;
          ...
          default:
              ...
              $('.soundPoint')[indice].play();
//              $("#gtest").append("</br>indice : "+indice);

//              haoken
              if (indice==0) $("#flame").addClass("flamisation");
//              coin
              $("#coin").show();
              if (indice==1) flipCoin();
//              1up
              if (indice==2) $("#champi").addClass("champisation");
